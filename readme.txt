 Kimera: Simple FF7PC 3D model editor v0.97b:
=============================================
	What's this?:
	-------------
	...
	New in this version:
	--------------------
		-Added options to load and save battle animations packs (including limit breaks).
		-Fixed bad limit breaks animations packs names
		-Miscelaneous fixes.
